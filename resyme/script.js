...
var resumeEdit = document.getElementById('edit-button');
...
form.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    var nameInput, roleInput, emailInput, phoneInput, addressInput, linkedinInput, facebookInput, profilePictureInput, educationInput, skillsInput, experienceInput, photoFile, photoBase64, buttonContainer, queryParams, uniqueUrl;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                resumePhone.textContent = "".concat(phoneInput);
                ...
                buttonContainer = document.querySelector('.button1');
                if (buttonContainer) {
...
window.onload = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        ...
        if (params.has('resumeName')) {
            ...
            resumePhone.textContent = "".concat(params.get('resumePhone'));
        ...
        resumeEdit.addEventListener('click', function () {
            var _a, _b;
            // Show the form
        ...
        (_b = document.getElementById('download-button')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', function () {
            var resumeElement = document.getElementById('resume-page');
            if (resumeElement) {
